                ...
                >
                  <div className="text-center mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-gray-900 mb-3">
                      Falez Yabancı Dil Kursu Gizlilik Politikası
                    </h2>
                  ...
                  <div className="space-y-8 text-gray-700 leading-relaxed">
                    <div className="bg-gray-50 rounded-xl p-6 border-l-4 border-orange-500">
                      <p className="text-lg">
                        Falez Yabancı Dil Kursu olarak, kişisel verilerinizin
                        güvenliği ve gizliliği bizim için son derece önemlidir.
                        Bu gizlilik politikası, web sitemizi kullandığınızda
                        veya hizmetlerimizden yararlandığınızda toplanan
                    ...
                    <div className="grid gap-6">
                      <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow duration-300">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          ...
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
                            <span>Eğitim geçmişi ve dil seviyesi</span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
                            <span>
                      ...
                      <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow duration-300">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          <div className="flex items-center space-x-2">
                            ...
                            <span>
                              Eğitim hizmetlerimizi sunmak ve iyileştirmek
                            </span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                          ...
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                            <span>İletişim kurmak ve bilgilendirme yapmak</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow duration-300">
                        ...
                        <p className="text-gray-600">
                          Kişisel verilerinizi üçüncü taraflarla paylaşmayız,
                          ancak yasal zorunluluk durumunda veya açık rızanız
                          olduğunda bu kural geçerli olmayabilir.
                        </p>
                      </div>
                      ...
                      <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow duration-300">
                        ...
                        <p className="text-gray-600">
                          Kişisel verilerinizi korumak için uygun teknik ve
                          organizasyonel önlemler alırız. Verilerinize yetkisiz
                          erişim, değişiklik, ifşa veya imha edilmesini önlemek
                          için çalışırız.
                        </p>
                      </div>
                      ...
                      <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow duration-300">
                        ...
                        <p className="text-gray-600">
                          Web sitemizde kullanıcı deneyimini iyileştirmek için
                          çerezler kullanırız. Tarayıcı ayarlarınızdan çerezleri
                      ...
                      <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow duration-300">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          ...
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-indigo-500 rounded-full"></div>
                            <span>Düzeltme ve güncelleme hakkı</span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-indigo-500 rounded-full"></div>
                            <span>Silme hakkı</span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-indigo-500 rounded-full"></div>
