  ...
  return (
    <footer className="bg-white py-8 sm:py-10 lg:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start mb-6 sm:mb-8 space-y-6 lg:space-y-0">
          ...
          <div className="mb-4 lg:mb-0">
            <div className="flex items-center mb-3">
              ...
              <img
                ...
                className="w-[400px] h-[50px] sm:w-20 sm:h-20 lg:w-24 lg:h-24 object-cover"
              />
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="flex space-x-2 sm:space-x-3">
            ...
            <a
              href="#"
              className="w-8 h-8 sm:w-10 sm:h-10 bg-orange-500 hover:bg-orange-600 rounded-lg flex items-center justify-center transition-colors duration-200"
              aria-label="Facebook"
            >
              <svg
